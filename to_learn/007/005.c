...
void draw_image(t_var *var, t_img *img, int x_start, int y_start, /*int x_end, int y_end,*/ int scale)
{
...
int loop(t_var *var)
{
	...
	draw_image(var, &var->img, i, 0, 2); // we draw the_made_image where we will put the image
